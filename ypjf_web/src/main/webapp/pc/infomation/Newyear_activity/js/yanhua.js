...
//
//  var lastTime;
//// getRandom(window.width / 3, window.width * 2 / 3)
//  function animate() {
//    ctx.save();
...
//      var x = getRandom(canvas.width *1/ 50, canvas.width * 4 / 50);
//      var y = getRandom(50, 200);
//
//      // var x01 = getRandom(10,12);
//      function ran() {//生成数组  俩个区间-----------------------------------------------------------
//        var arr01=[];
//        var c01= getRandom(50,60);
//        var c02= getRandom(1800,1810);
//        arr01.push(c01)
//        arr01.push(c02)
//        return arr01;
//      }
...
//        // console.log(ran()[1])
//
//  var xx=parseInt(Math.random()*100)%2
//        // console.log(xx)
//      if (random) {
...
//    var y = event.clientY;
//    // document.title=x+"--"+y
//    var bigboom = new Boom(getRandom(canvas.width / 3, canvas.width * 2 / 3), 2, "#000", {
//      x: x,
//      y: y
//    });
//    bigbooms.push(bigboom)
