...
<html>
	...
	<body>
		...
		<!-- <iframe src="../head3.html?index=6" width="100%" height="110px" scrolling="no" name="head"  style="border:0px;"></iframe> -->
		<!-- 头像上传框 -->
		<!-- <input type="file" style="display: none;" id="file-input" name="file" /> -->
		<!-- 主体 -->
				...
				<div class="person">
					<div class="left">
						<div class="up-img-cover touXiang"  id="up-img-touch" >
							...
							<img class="am-circle" alt="点击图片上传" src="${not empty pcuser.header ? pcuser.header : '/yingpu/pc/img/userimg.jpg'}"  id="user-avatar">
						</div>
						<!-- <div class="touXiang">
							<div class="shade">
								<span>更换头像</span>
						...
						<div class="text">
							<p class="name"><span class="nm">您好,JQDCJR${fn:substring(pcuser.phone,8,11)}</span><a class="bq" href="/yingpu/pc/html/level/level.html">普通会员</a></p>
							<p class="wenhou"></p>
						</div>
						<div class="message">
			...
			<div class="am-modal-bd  up-frame-body">
				...
				<div class="am-form-group am-form-file">
				  <div class="am-fl">
					<button type="button" class="am-btn am-btn-default am-btn-sm">
					  <i class="shangchuan"><img src="/yingpu/pc/html/account/cai123/img/shangchuan.png" ></i> 选择要上传的文件</button>
				  </div>
			  ...
			  <div class="am-g am-fl">
				<div class="up-control-btns">
					<span class="rotate-left"  onclick="rotateimgleft()"><img src="/yingpu/pc/html/account/cai123/img/zuozhuan.png" ></span>
					<span class="rotate-right" onclick="rotateimgright()"><img src="/yingpu/pc/html/account/cai123/img/youzhuan.png" alt=""></span>
					<span class="check" id="up-btn-ok" url="admin/user/upload.action"><img src="/yingpu/pc/html/account/cai123/img/duigou.png" ></span>
				</div>
			  </div>
		...
		<script src="../../../js/coms/ajaxfileupload/ajaxfileupload.js" type="text/javascript" charset="utf-8"></script>
		

		
		<script src="/yingpu/pc/html/account/cai123/js/amazeui.min.js" charset="utf-8"></script>
		<script src="/yingpu/pc/html/account/cai123/js/cropper.min.js" charset="utf-8"></script>
		<script src="/yingpu/pc/html/account/cai123/js/custom_up_img.js" charset="utf-8"></script>
