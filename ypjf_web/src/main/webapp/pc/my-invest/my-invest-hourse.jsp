...
经营管理等因素导致借款人的经济状况不良，进而有逾期之风险。</p>
						...
						<div class="zhengxin">
							...
							<ul class="neirong">
								...
								<li class="clearFix">
                                    <%--<pre><p class="p1"><span class="span1">${data.borrowUser[0].creditReportSituation}</span></p></pre>--%>
					...
					<li class="tab2">
						<div class="box1">
							...
							<p class="miaoshu">房融贷，主要针对名下有房产，有稳定收入来源的借款人提供增加资金周转服务，房产权利人以房产为抵押物，申请贷款，用于各种消费、资金周转和经营性用途的业务。</p>
							<div class="liucheng">
