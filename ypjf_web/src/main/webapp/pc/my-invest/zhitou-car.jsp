...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="my-invest/css/my-invest-zhitou.css"/>
	...
	<iframe src="head3.html" class="iframe-headfu" width="100%" scrolling="no"  style="border:0px;display: block;z-index:1000"></iframe>
				...
				<ul class="tab">
					<li class="tab1">
						...
						<div class="wupin-message">
							...
							<ul class="neirong">
								<li class="clearFix">
									<p class="p1"><span class="span1">车辆型号：</span><span class="span2">${data.borrowUser[0].carModel}</span></p>
									<p class="p1"><span class="span1">购买时间：</span><span class="span2">${data.borrowUser[0].carPurchaseDate}</span></p>
									<p class="p1"><span class="span1">购买价格：</span><span class="span2">${data.borrowUser[0].carPriceOnBuy}</span></p>
									<p class="p1"><span class="span1">抵押估价：</span><span class="span2">${data.borrowUser[0].carValuation}</span></p>
									<p class="p1"><span class="span1">行驶公里：</span><span class="span2">${data.borrowUser[0].carRunMileage}</span></p>
								</li>
								<li class="clearFix">
									<p class="p1"><span class="span1">车牌号码：</span><span class="span2">${fn:substring(data.borrowUser[0].carLicenseNumber,0,1 )}****${fn:substring(data.borrowUser[0].carLicenseNumber,5 ,7 )}</span></p>
						...
						<div class="safe">
							...
							<ul class="list clearFix" >
								...
								<li>
									<div class="zuo"><img src="my-invest/img/imgb2.png" alt=""></div>
									<div class="you">
										<p class="p1">行驶证</p>
										<p class="p2">通过审核</p>
									</div>
								...
								<li>
									<div class="zuo"><img src="my-invest/img/imgb5.png" alt=""></div>
									<div class="you">
										<p class="p1">借款协议</p>
										<p class="p2">通过审核</p>
									</div>
								...
								<li>
									<div class="zuo"><img src="my-invest/img/imgb6.png" alt=""></div>
									<div class="you">
										<p class="p1">其他借款说明</p>
										<p class="p2">通过审核</p>
									</div>
								...
								<li>
									<div class="zuo"><img src="my-invest/img/imgb8.png" alt=""></div>
									<div class="you">
										<p class="p1">车辆登记证</p>
										<p class="p2">通过审核</p>
									</div>
					...
					<li class="tab2">
						<div class="box1">
							...
							<p class="miaoshu">车贷融 车抵押/质押贷款业务为借款人提供相关信用咨询、车辆评估、抵质押借款、协议管理、回款管理等多方面的服务，借款人以自有车辆为抵押物获得出借资金，公司安排专业人员对抵押车辆进行GPS安装。在合同期间，借款人仍可正常使用该车辆。质押贷款中，由快趣贷为借款人妥善保管车辆。</p>
							<div class="liucheng">
								<img src="my-invest/img/xiangmu-liucheng.png" >
							</div>
						</div>
						<div class="box2">
							<p class="title">项目介绍</p>
							<div class="qiehuan" style="display: none"><span class="active" id="shijing">项目实景</span> / <span id="zhengjian">借款人证照</span></div>
							<div class="banner" id="invisible">
								<div class="swiper-container" >
									<a href="javascript:groupbay()" style="display:block;padding-top:72px; display: block;" class="weidenglu">登录查看基本信息</a>
									<a style="display:none;padding-top:72px; color: blue;cursor: pointer" class="yidenglu"  onclick="ShowDiv('borrowApply','fade')">查看信息</a>
								</div>
							</div>
							<div class="banner" id="jianjietu" style="display: none">
								<div class="swiper-container"  >
							...
							<div class="banner" style="display: none" id="zhengzhaotu" >
								<div class="swiper-container"  >
									<div class="swiper-wrapper" id="zhengzhao" data="${data.project[0].businessLicense}">
									</div>
								</div>
						...
						<div class="box3">
							...
							<p class="miaoshu">根据国家法律法规及行业相关规范要求，九趣贷对借款人隐私给予保护，对借款人部分信息进行了符合监管要求的脱敏处理。</p>
						</div>
					</li>
					<li class="tab3">
		...
		<div id="borrowApply" class="borrow-apply">
			<div class="borrow-apply-t clearFix" id="move">
				<h3 >请输入验证码</h3>
			...
			<div class="borrow-msg">
				<form action="/yingpu/app/loan/add/pc/json" method="post" id="loanform">
					...
					<div class="line clearFix">
						<p>图形验证码</p>
						<input type="text" name="code" id="text" value="" placeholder="请输入验证码">
						<img src="/yingpu/getCaptcha" id="yanzhengma" onclick="realodImg();" style="width: 140px;height: 36px;">
					</div>
					<div class="btns">
						<span onclick="tijiao();" class="tijiao">确定</span>
						<span class="reset" onclick="CloseDiv('borrowApply','fade')">取消</span>
					</div>							
...
//							html+='<td>'+new Date(o.createTime).Format('yyyy-MM-dd hh:mm:ss')+'</td>';
        ...
        function tijiao(){
            ...
            $.post('/yingpu/pc/getYanZhengMa',{code:code},function(data){
                // console.log(data);
                if(data.status=='ok'){
                    CloseDiv('borrowApply','fade');
