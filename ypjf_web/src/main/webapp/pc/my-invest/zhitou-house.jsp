						...
						<ul class="line2 clearFix">
							...
							<li>
								...
								<p>
									...
									<span class="you">编号:JQD*****${fn:substring(data.borrower[0].legalPersonPhone, 9, 11)}</span>
								</p>
							</li>
							<li>
								<p>
				...
				<ul class="tab">
					<li class="tab1">
						...
						<div class="wupin-message">
							...
							<ul class="neirong">
								<li class="clearFix">
									<p class="p1"><span class="span1">房屋地址：</span><span class="span2">${data.borrowUser[0].houseAddress}</span></p>
									<p class="p1"><span class="span1">房产产权人：</span><span class="span2">${data.borrowUser[0].housePropertyOwner}</span></p>
									<p class="p1"><span class="span1">房龄：</span><span class="span2">${data.borrowUser[0].houseAge}</span></p>
									<p class="p1"><span class="span1">购买年限：</span><span class="span2">${data.borrowUser[0].purchaseAgeLimit}</span></p>
									<p class="p1"><span class="span1">房屋面积：</span><span class="span2">${data.borrowUser[0].houseArea}㎡</span></p>
								</li>
								<li class="clearFix">
									<p class="p1"><span class="span1">房产评估价：</span><span class="span2">${data.borrowUser[0].housePropertyValuation}</span></p>
						...
						<div class="zichanpinggu">
							<p class="miaoshu">资产评估及风险提示：对借款人的资产进行综合评估，其经营所得或抵押物评估价值可以覆盖其借款本金及利息总额，但由于国家政策、市场竞争、
经营管理等因素导致借款人的经济状况不良，进而有逾期之风险。</p>
						</div>
						<div class="moneysafe">
						...
						<div class="safe safe1">
							...
							<ul class="list clearFix" >
								...
								<li>
									<div class="zuo"><img src="my-invest/img/imgb18.png" alt=""></div>
									<div class="you">
										<p class="p1">户口本</p>
										<p class="p2">通过审核</p>
									</div>
								...
								<li>
									<div class="zuo"><img src="my-invest/img/imgb19.png" alt=""></div>
									<div class="you">
										<p class="p1">信用报告</p>
										<p class="p2">通过审核</p>
									</div>
								...
								<li>
									<div class="zuo"><img src="my-invest/img/imgb20.png" alt=""></div>
									<div class="you">
										<p class="p1">运营商验证</p>
										<p class="p2">通过审核</p>
									</div>
								...
								<li>
									<div class="zuo"><img src="my-invest/img/a2.png" alt=""></div>
									<div class="you">
										<p class="p1">房产证</p>
										<p class="p2">通过审核</p>
									</div>
								...
								<li>
									<div class="zuo"><img src="my-invest/img/c13.png" alt=""></div>
									<div class="you">
										<p class="p1">房屋登记信息</p>
										<p class="p2">通过审核</p>
									</div>
								...
								<li>
									<div class="zuo"><img src="my-invest/img/c14.png" alt=""></div>
									<div class="you">
										<p class="p1">婚姻关系</p>
										<p class="p2">通过审核</p>
									</div>
								...
								<li>
									<div class="zuo"><img src="my-invest/img/c15.png" alt=""></div>
									<div class="you">
										<p class="p1">公证书</p>
										<p class="p2">通过审核</p>
									</div>
						...
						<div class="jiekuan-history">
							...
							<ul class="neirong">
								<li class="clearFix">
									<p class="p1"><span class="span1">借贷笔数：</span><span class="span2">${data.borrowUser[0].loanTimes}笔</span></p>
									<p class="p1"><span class="span1">历史还清期数：</span><span class="span2">wUser[0].payOffPeriods}</span></p>
					...
					<li class="tab2">
						<div class="box1">
							...
							<p class="miaoshu">好房贷，主要针对名下有房产，有稳定收入来源的借款人提供增加资金周转服务，房产权利人以房产为抵押物，申请贷款，用于各种消费、资金周转和经营性用途的业务。</p>
							<div class="liucheng">
								<img src="my-invest/img/haofangdai.png" >
							</div>
						</div>
