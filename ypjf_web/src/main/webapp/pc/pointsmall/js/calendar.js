(function(root, factory) {
    ...
    var defaults = {
        ...
        ITEM_STYLE = 'style="margin:6px;width:{w}px;height:{h}px;line-height:{h}px"',
    ...
    Calendar.prototype = {
        ...
        event: function() {
            ...
            _this.$element.on('click', ARROW_DATE, function() {
                ...
                arr = _this.getDisDateValue();
                _this.options.onMonthChange.call(this, arr[0], arr[1]);
                ...
                var arr = _this.getDisDateValue();
                _this.options.onMonthChange.call(this, arr[0], y);
            });
