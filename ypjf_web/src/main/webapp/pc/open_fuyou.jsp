...
<body>
	<div class="top">
		<div class="center">
			...
			<p class="wel left">免费注册营普金服账号，已有账号请  <a href="login">登录</a></p>
		</div>
	</div>
				...
				<div class="rejister-form left">
					...
					<!--<form id="reg" action="" method="post" onsubmit="return false;">
						<div class="msg">
							...
							<input type="number" name="phone" id="tel" placeholder="请输入您的手机号码" />
						</div>
						<div class="msg">
						...
						<div class="msg">
							...
							<input type="password" name="confirm_password" id="tel" placeholder="请输入6-16位字母和数字" />
						</div>
						<div class="vert">
							<div class="msg left">
						...
						<div class="msg visit-code">
							...
							<input type="password" name="inviteCode" id="tel" placeholder="请输入邀请人的手机号码" />
							<span class="chioce">选填</span>
						</div>
						<div class="account-control">
							<input type="checkbox" name="agree" id="" value="" checked="checked"/>
							<label for="agree">我已阅读并同意<span>《营普金服用户注册协议》</span></label>
						</div>
						<input type="submit" value="立即注册" class="rejister-btn"/>
					</form>
				-->
					<!--注册成功弹出以下对话框-->
					<!--注册成功弹出以下对话框-->
					<div class="rejister-ok" style="display: block">
						<p><span class="ok"></span>恭喜您注册成功！</p>
						<p>开通富友账户，开始理财!!!</p>
						<p>
							<a class="active" onclick="$('#fade').show();$('#openFuyou').show();$('#openFuyou form').show()">立即开通</a>
							<a href="html/account.html">暂不开通</a>
						</p>
					</div>
	...
	<!--开通富友账户弹出层-->
	<div id="fade" class="black-overlay" style="display: block;"></div>
	<div class="open-fuyou" id="openFuyou" style="display: block;">
		...
		<div class="open-fuyou-form">
			...
			<form id="fy" action="" method="post" onsubmit="return false;">
				...
				<label><span>真实姓名</span><input name="realName" type="text" value="胡国辉" placeholder="请输入真实姓名"/></label>
				<label><span>身份证号</span><input name="idCard" type="text" value="612325199512202117" placeholder="请输入身份证号"/></label>
				<label><span>银行卡号</span><input name="bankNum" type="text" value="6217853600032426511" placeholder="请输入您的银行卡号"/></label>
	...
	<div class="open-fuyou-ok" id="openFuyou-ok">
		<div class="open-fuyou-tit">
			<p>开通富友金账户</p>
			<span class="close" onclick="location.href = 'html/account.html';"></span>
		</div>
