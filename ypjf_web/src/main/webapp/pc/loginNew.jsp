		...
		<div class="center clearfix">
			...
			<div class="login-box right">
				<ul class="menu">
					...
					<p class="miaoshu" style="cursor: pointer;" onclick="javascript:location.href='register';">立即注册</p>
				</ul>
				<form action="" method="post" id="loginform">
					...
					<input type="button" style="cursor: pointer;" onclick="login();" value="马上登陆" class="login-btn"/>
				</form>
			</div>
		</div>
	</div>
