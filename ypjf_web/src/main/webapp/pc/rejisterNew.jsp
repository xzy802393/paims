			...
			<div class="rejister-box clearfix">
				...
				<div class="rejister-form right">
					...
					<form id="reg" action="" method="post" onsubmit="return false;">
						...
						<a class="denglu" href="login">已有账号，立即登录</a>
					</form>
					...
					<div class="rejister-ok" id="">
						...
						<!--<p>开通富友账户，开始理财!</p>-->
						<p>
							<a class="active" href="open_fuyouNew.jsp" onclick="showFYRegister();" style="width: 296px;height: 45px;display: block;background:url(img/open-fuyou-btnBg.png) no-repeat center;margin: 0 auto;line-height: 45px;color: #fff;font-size: 16px;cursor: pointer;border-radius: 4px;">立即开通富友支付金账户，开始理财！</a>
