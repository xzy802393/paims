...
import com.cz.yingpu.system.entity.City;
import com.cz.yingpu.system.service.ICityService;
 ...
 * @see com.cz.yingpu.system.web.City
 */
@Controller
...
public class CityController  extends BaseController {
	...
	private String listurl="/city/cityList";
	...
	public String list(HttpServletRequest request, Model model,City city) 
			throws Exception {
		ReturnDatas returnObject = adminListjson(request, model, city);
	...
	public @ResponseBody
	ReturnDatas adminListjson(HttpServletRequest request, Model model,City city) throws Exception{
...
//		}
		...
		// ==执行分页查询
		List<City> datas=cityService.queryForListByEntity(city,page);
