...
import com.cz.yingpu.system.service.IRoleMenuService;
 ...
 * @see com.cz.yingpu.system.web.RoleMenu
 */
@Controller
...
public class RoleMenuController  extends BaseController {
	...
	private String listurl="/system/rolemenu/rolemenuList";
	 ...
	 */
	@RequestMapping("/list")
	public String list(HttpServletRequest request, Model model,RoleMenu roleMenu) 
			throws Exception {
		ReturnDatas returnObject = listjson(request, model, roleMenu);
	...
	public @ResponseBody
	ReturnDatas listjson(HttpServletRequest request, Model model,RoleMenu roleMenu) throws Exception{
		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
		// ==构造分页请求
		Page page = newPage(request);
		// ==执行分页查询
		List<RoleMenu> datas=roleMenuService.findListDataByFinder(null,page,RoleMenu.class,roleMenu);
			returnObject.setQueryBean(roleMenu);
	...
	public String look(Model model,HttpServletRequest request,HttpServletResponse response)  throws Exception {
		...
		model.addAttribute(GlobalStatic.returnDatas, returnObject);
		return "/system/rolemenu/rolemenuLook";
	}
	...
	public @ResponseBody
	ReturnDatas saveorupdate(Model model,RoleMenu roleMenu,HttpServletRequest request,HttpServletResponse response) throws Exception{
		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
		returnObject.setMessage(MessageUtils.UPDATE_SUCCESS);
		try {
		
			java.lang.String id =roleMenu.getId();
	...
	public String updatepre(Model model,HttpServletRequest request,HttpServletResponse response)  throws Exception{
		ReturnDatas returnObject = lookjson(model, request, response);
		model.addAttribute(GlobalStatic.returnDatas, returnObject);
		return "/system/rolemenu/rolemenuCru";
	}
