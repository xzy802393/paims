...
public class MessageController  extends BaseController {
	...
	private String listurl="/system/message/messageList";
	 ...
	 */
	@RequestMapping("/list")
	public String list(HttpServletRequest request, Model model,Message message) 
			throws Exception {
		ReturnDatas returnObject = listjson(request, model, message);
	...
	public void listexport(HttpServletRequest request,HttpServletResponse response, Model model,Message message) throws Exception{
		// ==构造分页请求
		Page page = newPage(request);
	
		File file = messageService.findDataExportExcel(null,listurl, page,Message.class,message);
		String fileName="message"+GlobalStatic.excelext;
	...
	public String look(Model model,HttpServletRequest request,HttpServletResponse response)  throws Exception {
		...
		model.addAttribute(GlobalStatic.returnDatas, returnObject);
		return "/system/message/messageLook";
	}
	...
	public String updatepre(Model model,HttpServletRequest request,HttpServletResponse response)  throws Exception{
		ReturnDatas returnObject = lookjson(model, request, response);
		model.addAttribute(GlobalStatic.returnDatas, returnObject);
		return "/system/message/messageCru";
	}
	...
	public @ResponseBody ReturnDatas delete(HttpServletRequest request) throws Exception {
		...
		try {
		  ...
		  if(StringUtils.isNotBlank(strId)){
			 id= java.lang.Integer.valueOf(strId.trim());
				messageService.deleteById(id,Message.class);
	...
	ReturnDatas deleteMore(HttpServletRequest request, Model model) {
		...
		try {
			...
			messageService.deleteByIds(ids,Message.class);
		} catch (Exception e) {
			return new ReturnDatas(ReturnDatas.ERROR,
					MessageUtils.DELETE_ALL_FAIL);
		}
