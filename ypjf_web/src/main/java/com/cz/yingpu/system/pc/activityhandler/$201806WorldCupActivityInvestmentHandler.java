...
/**
 * 18年6月欢呼世界杯，营普陪你嗨活动投资相关处理
 */
public class $201806WorldCupActivityInvestmentHandler extends AbstractActivityInvestmentHanlder {
	public $201806WorldCupActivityInvestmentHandler(int actId) {
		super(actId);
	}
