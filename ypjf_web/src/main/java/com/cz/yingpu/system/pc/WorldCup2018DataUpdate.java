 ...
 */
@Controller
@RequestMapping(value = "/pc/task")
public class WorldCup2018DataUpdate extends BaseLogger {
	...
	@RequestMapping(value = "/update/2018/json")
	@ResponseBody
	public Object updateWorldCup2018Score() {
