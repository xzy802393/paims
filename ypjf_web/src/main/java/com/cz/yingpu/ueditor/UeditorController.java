package com.cz.yingpu.ueditor;

import com.cz.yingpu.frame.controller.BaseController;
import com.cz.yingpu.frame.util.FileUtils;
import com.cz.yingpu.frame.util.GlobalStatic;
import com.cz.yingpu.frame.util.HttpClientUtils;
...
//    	UeditorConfig config=new UeditorConfig(path+fileuploadpath);
    	UeditorConfig config=new UeditorConfig("http://47.105.74.124:33333/"+fileuploadpath );
...
//		 String tempDir="D:\\apache-tomcat-7.0.88\\webapps\\yingpu\\"+fileuploadpath+fileName;
